...
const imageTextRow1 = [
  "Все модели Rolex, выпущенные после 2002 года, имеют крошечную заводную головку, выгравированную лазером в положении «6 часов». Он расположен в стекле часов рядом с надписью «Сделано в Швейцарии» и виден только при использовании специальных инструментов.", "Мастера Rolex с особым вниманием создают свои эксклюзивные хронометры. Их внимание к мельчайшим деталям делает часы идеальными. Наши копии практически невозможно отличить от оригинала без микроскопа",
      ...
      <div className="content-container">
        <div className="w-full max-w-8xl px-6 py-12 bg-white rounded-lg shadow-lg">
          ...
          <p className="text-lg mb-6">
            Мы специализируемся на 100% только на Rolex, от архивных моделей до новейших. В нашем магазине вы найдете
