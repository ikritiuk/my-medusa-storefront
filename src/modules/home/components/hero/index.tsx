            ...
            <div className="relative text-center w-full">
              ...
              <Link href="/collections/rolex">
                <img
                  ...
                  alt="Rolex"
                  className="rounded shadow-lg transition-transform duration-500 hover:scale-110 hover:rotate-1"
                />
              </Link>
            </div>
              ...
              <div key={index} className="flex-none w-80 shadow-lg rounded-lg">
                <Link href={watch.link}>
                  <div className="relative">
                    ...
                    />
                    <div
                      className="absolute bottom-2 left-1/2 transform -translate-x-1/2 bg-black bg-opacity-50 text-white text-lg px-2 py-1 rounded transition-all duration-300 group-hover:shadow-lg group-hover:text-yellow-400 z-10">
                      {watch.name}
                    </div>
